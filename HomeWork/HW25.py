"""
Использовать код с занятия:
- закрыть доступ к переменным
- Сделать набор _get_ _set_ для 4 переменных (8 доп методов)
- Сделать через декоратор @property
"""
...
class Account:
    ...
    def print_info(self):
        ...
        print('-' * 20)
        print(f'#{self.__num}\n'
              f'Владелец: {self.__surname}\n'
              f'Текущий баланс: {self.__value}\n'
              f'Проценты: {self.__percent:.0%}')
        print('-' * 20)
